...
CREATE TABLE `like_comment` (
  ...
  KEY `fk_like_comment_idx` (`comment_id`),
  KEY `fk_like_comment_user_idx` (`user_id`),
  CONSTRAINT `fk_like_comment` FOREIGN KEY (`comment_id`) REFERENCES `comment` (`comment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-12-03 18:29:15
